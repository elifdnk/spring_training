...
@JsonInclude(JsonInclude.Include.NON_NULL) //if data not null, show it.
public class AddressDTO {
    ...
    private Integer currentTemperature; //Weather information, which will later get it from 3rd party API
